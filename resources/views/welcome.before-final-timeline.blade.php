...
<section class="section">
    ...
    <div class="cards">
        <div class="card"><img src="{{ asset('images/truck-volvo-f88-1970.jpg') }}" alt="Volvo F88 1970" style="width:100%;height:220px;object-fit:cover;border-radius:14px;"><h3>1970 — Volvo F88</h3><p>جيل مبكر من الشاحنات الثقيلة، اشتهر بالقوة والبساطة وارتبط بتطور النقل لمسافات طويلة في السبعينيات.</p></div>
            <img src="{{ asset('images/truck-volvo-f10.jpg') }}" alt="Volvo F10" style="width:100%;height:220px;object-fit:cover;border-radius:14px;">
            <img src="{{ asset('images/truck-volvo-f12-1980.jpg') }}" alt="Volvo F12 1980" style="width:100%;height:220px;object-fit:cover;border-radius:14px;">
    </div>
</section>
