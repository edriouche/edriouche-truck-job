...
<section class="section">
    <div class="section-title">
        <h2>🚛 ذاكرة الشاحنة المغربية — 1970 إلى 1990</h2>
        <p>شاحنات من جيلٍ قديم ارتبط بذاكرة النقل الطرقي في المغرب، إلى جانب الشاحنات الكبرى والثقيلة التي خدمت المسافات الطويلة.</p>
    </div>
    <div class="cards">
        <div class="card"><img src="{{ asset('images/truck-volvo-f88-1970.jpg') }}" alt="Volvo F88 1970" style="width:100%;height:220px;object-fit:cover;border-radius:14px;"><h3>شاحنات الجيل القديم</h3><p>نماذج من الشاحنات التي عرفتها طرقات المغرب خلال السبعينيات والثمانينيات والتسعينيات.</p></div>
        <div class="card"><div style="font-size:4rem;text-align:center;padding:20px;">🚚</div><h3>ذاكرة الطريق</h3><p>مرحلة مهمة من تاريخ مهنة النقل، قبل التطور الكبير الذي عرفته الشاحنات الحديثة.</p></div>
        <div class="card"><div style="font-size:4rem;text-align:center;padding:20px;">🚛</div><h3>الشاحنات الكبرى والثقيلة</h3><p>شاحنات ارتبطت بالنقل الثقيل والرحلات الطويلة وحملت أجيالًا من السائقين مسؤولية الطريق.</p></div>
    </div>
</section>
